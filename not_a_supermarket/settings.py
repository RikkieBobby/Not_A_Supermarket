"""
Django settings for not_a_supermarket project.
...
SECRET_KEY = 'django-insecure-)6%39#y1%0vw@k2xo16o9r49d!n0_u(34tw$*^k^oh4bz58)fd'
...
ROOT_URLCONF = 'not_a_supermarket.urls'
...
WSGI_APPLICATION = 'not_a_supermarket.wsgi.application'
...
STRIPE_WH_SECRET = os.getenv('STRIPE_WH_SECRET', 'whsec_...')